                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="https://markdownmail.com"
                                style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color:#fed700 ; font-size: 19px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 #ffffff; display: inline-block;">
                                <!-- <img src="https://laravel.com/img/notification-logo.png" class="logo"
                                    alt="Laravel Logo"
                                    style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; max-width: 100%; border: none;"
                                > -->
                                Tech City
                            </a>
                        </td>
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            questions, Call us 078 450 8270.</p>
                                        <h2
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        This is the order detail email</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
